<?php
$title = "Hassan CHPL - Chauffage & Sanitaire";
?><!DOCTYPE html>
<html lang="fr">
...
<body class="home layout2">
	...
	<div class="banner-section">
		<div class="banner-slider">
			<div class="banner-slide">
				...
				<div class="fig_text">
					<h3>Nous apportons du confort à</h3>
					<h2>votre maison 24/7!</h2>
				</div><!--fig_text end-->
			</div><!--banner-slide end-->
			<div class="banner-slide">
				<img src="images/resources/banner-img2.jpg" alt="">
				<div class="fig_text">
					<h3>Chauffage de haute qualité</h3>
					<h2>Installer & Entretenir</h2>
				</div><!--fig_text end-->
			</div><!--banner-slide end-->
			<div class="banner-slide">
				...
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 hlf-wdth full_wdth">
						<div class="service_details">
							...
							<div class="svss_info">
								<h3>Installateur Certifié</h3>
								<p>Si vous recherchez un service de qualité, notre entreprise est là pour vous.</p>
							</div>
					...
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 hlf-wdth full_wdth">
						<div class="service_details">
							...
							<div class="svss_info">
								...
								<p>Vous avez des problèmes avec votre système de chauffage, sanitaire , pompe à chaleur ou climatisation. Appelez-nous 24h/24 et 7j/7.</p>
							</div>
						</div><!--service_details end-->
					</div>
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 hlf-wdth full_wdth">
						<div class="service_details mag-b-0">
							...
							<div class="svss_info">
								<h3>Tarification juste!</h3>
								<p>Nous offrons un travail propre et de qualité tout en respectant le budget de chaques clients.</p>
							</div>
						</div><!--service_details end-->
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-sm-6">
						<div class="qck-services">
							<h4>Spécialiste en système de chauffage et sanitaire </h4>
	...
	<section class="block service-block">
		<div class="container">
			<div class="sec-title">
				<h4>Ouvert 24h/24 et 7j/7 avec le personnel d'urgence</h4>
		...
		<div class="choose_services_sec">
			...
			<ul class="tabs_list">
				<li class="active" data-tab="cooling_sli">
					...
					<span class="svs">Services de refroidissement</span>
				</li>
				<li class="heating" data-tab="heating_sli">
					<span class="svs">Services de chauffage</span>
					<span class="tc_icon">
			...
			<div class="srvs_slider active" id="cooling_sli">
				<div class="srvs_dv">
					<img src="images/resources/simg1.jpg" alt="">
					<h2 class="srvs_heading">Climatisation</h2>
					<div class="srvs_details">
						<h3>Climatisation</h3>
						<p>La climatisation est un système assez simple. Une unité de climatisation extérieure, fonctionnant conjointement avec l'unité intérieur et les conduits d'air de la maison, fournit de l'air frais dans chaque pièce ou dans une seul.</p>
						<a href="#" title="" class="play_icon"><i class="fa fa-play-circle"></i></a>
					</div>
				</div><!--srvs_dv end-->
				<div class="srvs_dv">
					<img src="images/resources/simg2.jpg" alt="">
					<h2 class="srvs_heading">Installation des climatiseurs</h2>
					<div class="srvs_details">
						<h3>Installation des climatiseurs</h3>
						<p>Nous installons les systèmes de climatisations et de refroidissement pars air pulsé. Nous nous occupons directement de la mise en service et de la programmation selon vos besoins.</p>
						<a href="#" title="" class="play_icon"><i class="fa fa-play-circle"></i></a>
					</div>
				</div><!--srvs_dv end-->
				<div class="srvs_dv">
					<img src="images/resources/simg3.jpg" alt="">
					<h2 class="srvs_heading">Entretien de climatiseur</h2>
					<div class="srvs_details">
						<h3>Entretien de climatiseur</h3>
						<p>Entretien de vos appareils de climatisation et de leurs conduites.</p>
						<a href="#" title="" class="play_icon"><i class="fa fa-play-circle"></i></a>
					</div>
				</div><!--srvs_dv end-->
				<div class="srvs_dv">
					<img src="images/resources/simg4.jpg" alt="">
					<h2 class="srvs_heading">Installation de thermostat</h2>
					<div class="srvs_details">
						<h3>Installation de thermostat</h3>
						<p>Le theromstat est un sytème de régulation simplifié indispensable dans une installation. Grâce à lui, vous pouvez gérez la température que vous désirez selon vos besoins.</p>
						<a href="#" title="" class="play_icon"><i class="fa fa-play-circle"></i></a>
					</div>
				</div><!--srvs_dv end-->
				<div class="srvs_dv">
					<img src="images/resources/simg5.jpg" alt="">
					<h2 class="srvs_heading">Maintenance</h2>
					<div class="srvs_details">
						<h3>Maintenance</h3>
						<p>Nous réalisons l'entretien, la mise en service, la réparation... de vos sytèmes de climatisations.</p>
						<a href="#" title="" class="play_icon"><i class="fa fa-play-circle"></i></a>
					</div>
				</div><!--srvs_dv end-->
				<div class="srvs_dv">
			...
			<div class="srvs_slider" id="heating_sli">
				<div class="srvs_dv">
					<img src="images/resources/heat_img1.jpg" alt="">
					<h2 class="srvs_heading">Installation de chauffage</h2>
					<div class="srvs_details">
						<h3>Installation de chauffage</h3>
						<p>Le chauffage est un système assez simple. Composé d'un départ - retour, l'eau circule dans ceux-ci, elle est chauffée grâce à un échangeur situé généralement autour ou au dessus d'une flamme. (Chaudière) Ou bien, pars le billet d'un système de panneau solaire ou pompe à chaleur.</p>
						<a href="#" title="" class="play_icon"><i class="fa fa-play-circle"></i></a>
					</div>
				</div><!--srvs_dv end-->
				<div class="srvs_dv">
					<img src="images/resources/heat_img2.jpg" alt="">
					<h2 class="srvs_heading">Maintenance</h2>
					<div class="srvs_details">
						<h3>Maintenance</h3>
						<p>Nous réalisons l'entretien, la mise en service, la réparation... de vos sytèmes de chauffage.</p>
						<a href="#" title="" class="play_icon"><i class="fa fa-play-circle"></i></a>
					</div>
				</div><!--srvs_dv end-->
				<div class="srvs_dv">
					<img src="images/resources/heat_img3.jpg" alt="">
					<h2 class="srvs_heading">Chaudière</h2>
					<div class="srvs_details">
						<h3>Chaudière</h3>
						<p>Nous réalisons le remplacement de vos chaudière atmosphérique ou mazout, pars des chaudières à condensations pouvant réduire vos consommations de 30% à 40% selon vos consommations.</p>
						<a href="#" title="" class="play_icon"><i class="fa fa-play-circle"></i></a>
					</div>
				</div><!--srvs_dv end-->
				<div class="srvs_dv">
					<img src="images/resources/heat_img4.jpg" alt="">
					<h2 class="srvs_heading">Pompe à chaleur</h2>
					<div class="srvs_details">
						<h3>Pompe à chaleur</h3>
						<p>Nous réalisions l'installation de pompe à chaleur, ce système est généralement utilisé dans les nouvelles constructions ou les rénovations complètes. Ce système fonctionne uniquement avec l'électricité.</p>
						<a href="#" title="" class="play_icon"><i class="fa fa-play-circle"></i></a>
					</div>
				</div><!--srvs_dv end-->
				<div class="srvs_dv">
					<img src="images/resources/heat_img5.jpg" alt="">
					<h2 class="srvs_heading">Chauffage à air pulsé</h2>
					<div class="srvs_details">
						<h3>Chauffage à air pulsé</h3>
						<p>Nous réalisons l'installation des systèmes de chauffages pulsé, ils permettent de distribué de la chaleur via l'air et non via des radiateur ou chauffage sol.</p>
						<a href="#" title="" class="play_icon"><i class="fa fa-play-circle"></i></a>
					</div>
				</div><!--srvs_dv end-->
				<div class="srvs_dv">
	...
	<section class="block">
		...
		<div class="container">
			<div class="sec-title">
				<h4>Que faisons-nous d'autre</h4>
				<h2>Les services additionnels</h2>
			</div><!--sec-title end-->
				...
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 full_wdth">
						<div class="ads_service">
							...
							<h3>Service de systèmes fractionnés</h3>
							<p>Entretiens des systèmes fractionnés / split.</p>
						</div><!--ads_service end-->
					</div>
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 full_wdth">
						<div class="ads_service">
							...
							<h3>Chauffe-eau</h3>
							<p>Entretien et détartrages de vos chauffe-eau.</p>
						</div><!--ads_service end-->
					</div>
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 full_wdth">
						<div class="ads_service">
							...
							<h3>Test de pression gaz</h3>
							<p>Les appareils au gaz au besoin d'une pression minimal afin de fonctionner correctement.</p>
						</div><!--ads_service end-->
					</div>
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 full_wdth">
						<div class="ads_service">
							...
							<h3>Ramonage & Nettoyages des conduits</h3>
							<p>Nettoyage de vos conduits de ventilations ou de vos cheminées</p>
						</div><!--ads_service end-->
					</div>
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 full_wdth">
						<div class="ads_service">
							...
							<h3>Chauffage Sol & Radiateur</h3>
							<p>Pose et installation de circuit de chauffage sol ou de radiateur</p>
						</div><!--ads_service end-->
					</div>
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 full_wdth">
						<div class="ads_service">
							...
							<p>Installation d'adoucisseur au sel ou CO. Installation et rénovation des systèmes de récupération d'eau pluviale.</p>
						</div><!--ads_service end-->
					</div>
				</div>
			...
			<div class="faqs_qs_sec">
				<div class="row">
					<div class="col-lg-6 col-md-6">
						<div class="faqs-sec">
							<h3 class="sc-title">Chauffage et Climatisation <span>FAQ</span></h3>
							<div class="ht-accordion toggle">
								<div class="toggle-item">
									<h2>Quelle est la durée de vie de mon système HVAC ?</h2>
									<div class="content">
										<p>La fréquence à laquelle vous faites fonctionner votre système, l'âge du système, sa marque et son modèle, et s'il a été entretenu ou non régulièrement au cours de sa vie peuvent tous jouer un rôle important dans la durée de vie de votre système. La durée de vie est d'environ 15 ans.</p>
									</div>
								</div><!-- Toggle Item -->
								<div class="toggle-item">
									<h2>Quelles marques installez-vous ?</h2>
									<div class="content">
										<p>Nous plaçons toutes les marques selon la préférence du client, mais nous recommandons Vaillant ou Viessman.</p>
									</div>
								</div><!-- Toggle Item -->
								<div class="toggle-item">
									<h2>Qu'est-ce qu'une pompe à chaleur ?</h2>
									<div class="content">
										<p>La pompe à chaleur (PAC) est un équipement de chauffage fonctionnant aux énergies renouvelables. Cet équipement écologique récupère l'énergie naturelle présente dans l'environnement extérieur. Cette énergie, dispensée entre autres par le soleil, est présente partout : dans l'air qui nous entoure, dans le sol ou encore dans l'eau des nappes souterraines. La pompe à chaleur va extraire cette énergie gratuite pour la réinjecter dans un système de chauffage ou de production d'eau chaude sanitaire (Boiler). </p>
									</div>
								</div><!-- Toggle Item -->
								<div class="toggle-item">
									<h2>Ai-je besoin d'entretenir mes systèmes ?</h2>
									<div class="content">
										<p>L'entretien de vos appareils joue un rôle important sur la durée de vie de vos appareils , il est donc fortement conseillé d'entretenir vos appareils. En Belgique, l'entretien et le contrôle périodique de vos appareils au gaz est obligatoire tout les 2 ans. </p>
									</div>
								</div><!-- Toggle Item -->
					...
					<div class="col-lg-6 col-md-6">
						<div class="question_sec">
							<h3 class="sc-title">Posez une <span>question</span></h3>
							<form id="contactform" name="contactform" method="post" novalidate>
								<div id="success">
									<p>Votre message a bien été envoyé!</p>
								</div>
								<div id="error">
									<p>Une erreur s'est produite, essayez d'actualiser la page et de soumettre à nouveau le formulaire.</p>
								</div>
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-6">
									...
									<div class="col-lg-12">
										<div class="input_field slct">
											<select>
												...
												<option value="serive1">Devis gratuit </option>
												<option value="serive2">Dépannage</option>
												<option value="serive3">Entretien</option>
												<option value="serive4">Mise en service</option>
											</select>
										</div><!--input_field end-->
									</div>
									<div class="col-lg-12">
			...
			<div class="why_us_sec">
				<div class="row">
					...
					<div class="col-lg-6 col-md-8 col-sm-8">
						<div class="why_us">
							<h4>Nous sommes les meilleurs dans notre spécialité</h4>
							<h3 class="sc-title">Pourquoi <span>nous choisir?</span></h3>
							<ul class="proptz_list">
								<li>
									<div class="proptz_feature">
										...
										<div class="ptz_info">
											<h3>Nous croyons au maintien des valeurs.</h3>
											<p>Nous basons notre entreprise sur l'honnêteté, l'intégrité, le travail d'équipe et la responsabilité, et c'est ce que nos clients attendent de nous.</p>
										</div><!--ptz_info end-->
								...
								<li>
									<div class="proptz_feature">
										...
										<div class="ptz_info">
											<h3>Nous traitons chaque client comme une famille</h3>
											<p>Nous exécutons le travail dans la propreté et l'éfficacité. Comme si cela était pour nous.</p>
										</div><!--ptz_info end-->
									</div><!--proptz_feature end-->
								</li>
								<li>
									<div class="proptz_feature">
										...
										<div class="ptz_info">
											<h3>Notre travail, un loisir!</h3>
											<p>Nous faisons de notre métier, un loisir, un passe temps. C'est pour cela que chez Hassan CHPL, nous aimons faire notre métier.</p>
										</div><!--ptz_info end-->
									</div><!--proptz_feature end-->
								</li>
							</ul>
	...
	<section class="block">
		<div class="container">
			<div class="sec-title">
				<h4>Lisez nos derniers articles</h4>
				<h2>Nouvelles de la société</h2>
			</div><!--sec-title end-->
	...
	<section class="block sap-sec air_sec">
		...
		<div class="container">
			<div class="sep-text">
				<h2><span>Climatisation & Chauffage</span> Services Réparation & Entretien</h2>
				<p>Trop chaud? Trop froid? Au milieu de la nuit? Appelez-nous à tout moment. Nous sommes prêts.</p>
				<a href="#" title="" class="lnk_default apt_form_btn">Prendre rendez-vous</a>
			</div><!--sep-text end-->
		</div>
	</section><!--sap-sec end-->
	...
	<section class="block partners-sec">
		<div class="container">
			<div class="sec-title">
				<h4>Des marques de qualité auxquelles nous faisons confiance</h4>
	...
	<section class="newsletter-sec">
		<div  class="container">
			<ul class="nss_list">
				<li>
					<span>Service d'urgence</span> 24/24
				</li>
				<li>
		...
		<div class="appointment_form">
			...
			<form class="rqs_form" id="appointment-form" method="post" novalidate>
				...
				<div class="input_field datetimepicker-wrap">
					<input type="text" name="date-services" placeholder="Date de passage" class="datetimepicker">
				...
				<div class="input_field datetimepicker-wrap">
					<input type="text" name="time-services" placeholder="Heure de passage (08h00 - 20h00)" class="datetimepicker2">
	...
	<div class="popup_form direction_form">
		<div class="appointment_form">
			<div class="apt_form_head">
				<h3>Itinéraire du bureau</h3>
				<a href="#" title="" class="close_apt_form"><img src="images/close.png" alt=""></a>
			</div><!--apt_form_head end-->
			<div class="direction_map">
				<div class="mapouter">
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2521.06164350789!2d4.436971416293125!3d50.811496569163836!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c3db1ac3400af1%3A0x681bb45a546c1d99!2sHassan%20CHPL!5e0!3m2!1sfr!2sbe!4v1624724203008!5m2!1sfr!2sbe" width="1200" height="220" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
							<div class="adv_info">
								<h4>Adresse Bureau:  </h4>
								<p>Chaussée De Wavre 1997, 1160 Auderghem</p>
							</div><!--adv_info end-->
						</li>
					</ul>
				</form>
